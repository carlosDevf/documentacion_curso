...
![img crear archivo css📔](public/ima/createcss.png)
...
![img carpetas y archivos css](public/ima/carpetasycss.png)
...
![img enlazar HTML con CSS](public/ima/enlazarcsshtml.png)
...
## ![img de carpetas](public/ima/enlazaradetalle.png)
...
![img ejemplo de block](public/ima/block.png)
...
![img ejemplo de inline](public/ima/inline.png)
...
![img de box model](public/ima/boxmodel.png)
...
## ![img orden de propiedades](public/ima/ordencss.png)
...
![img código ejemplo](public/ima/cssejemcode.png)

En base al código anterior, así debe verse la salida en tu navegador.

![img salida de navegador](public/ima/cssfront.png)
...
![img de ejemplo border-radius](public/ima/bradius.png)

Aquí te dejo el ejemplo del código para poder aplicar esta propiedad.

![img código para border-radius](public/ima/codebr.png)
